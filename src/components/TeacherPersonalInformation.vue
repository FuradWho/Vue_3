...
export default {
  ...
  methods:{
    async getUserInfo(){
      ...
      this.formLabelAlign.userBirthday = res.data.teacherInfo.stuBirthday
      this.formLabelAlign.userName = res.data.teacherInfo.stuName
      this.formLabelAlign.userSex = res.data.teacherInfo.stuSex
      this.formLabelAlign.userEmail = res.data.teacherInfo.stuEmail
      this.formLabelAlign.userPhone = res.data.teacherInfo.stuPhone
    },
     handleUserFrom() {
      console.log(this.formLabelAlign)
      this.$http.post("/handleUserFrom", JSON.stringify(this.formLabelAlign)).then((res) => {
